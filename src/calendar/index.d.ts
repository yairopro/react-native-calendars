...
declare class Calendar extends Component<CalendarProps, State> {
    ...
    static propTypes: {
        ...
        hideDayNames: PropTypes.Requireable<boolean>; /** Disable days by default */
        hideArrows: PropTypes.Requireable<boolean>;
        renderArrow: PropTypes.Requireable<(...args: any[]) => any>; /** Allow selection of dates before minDate or after maxDate */
